        ...
        <div class="col-md-12">
            ...
            <div class="content">
                <article class="thread thread-card  article-nav">
                    <a href="/">首页</a> &gt; <a href="<?=Url::to(['site/index','cid'=>$article['cid']])?>"><?=$article['cname']?></a> &gt; <span><?=$article['title']?></span>
                </article>
                <div class="card thread-card ps-parent">
                    ...
                    <header class="page-header with-author">
                        ...
                        <div class="thread-meta">
                            ...
                            <span class="article-info">&nbsp;更新时间：<time><?=date('Y-m-d H:m:s',$article['update_date'])?></time></span>
                            ...
                            <div class="ds-replybox">
                                ...
                                <form method="post" class="comment-form">
                                    ...
                                    <div class="ds-textarea-wrapper ds-rounded-top">
                                        <textarea id="content" placeholder="亲 , 想评论必须先登录哦."></textarea>
